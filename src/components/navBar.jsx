  ...
  return (
    <div className='flex justify-between items-center w-full h-10 px-2 bg-black text-white fixed top-0 left-0 right-0'>
        ...
        <ul className='hidden md:flex'>
            ...
            {links.map(({id, link})=>(<li key={id} className='px-4 mr-4 cursor-pointer capitalize font-medium text-gray-500 hover:scale-105 duration-200'>
        ...
        {nav && (
            ...
            {links.map(({id, link})=>(<li key={id} className='px-4 mr-4 cursor-pointer capitalize py-6 text-4xl'>
